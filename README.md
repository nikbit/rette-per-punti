...
> Apri questa pagina in [https://nikbit.github.io/rette-per-punti/](https://nikbit.github.io/rette-per-punti/)
...
* cerca **https://github.com/nikbit/rette-per-punti** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/nikbit/rette-per-punti/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/nikbit/rette-per-punti** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/nikbit/rette-per-punti/raw/master/.github/makecode/blocks.png)
